 ...
 * @author ppolo
 */
public class CamDialog extends javax.swing.JDialog {

    public final Webcam webcam = Webcam.getDefault();
    private byte[] hinh = null;

    /**
     * Creates new form CamDialog
     */
    public CamDialog() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CamDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CamDialog dialog = new CamDialog();
